...
@click.command(context_settings=CONTEXT_SETTINGS,
               short_help='Stops a delta pipeline and deletes associated its Databricks resources')
@click.argument('spec_arg', default=None, required=False)
@click.option('--spec', default=None, help=PipelineSpecClickType.help)
...
@click.option('--spec', default=None, help=PipelineSpecClickType.help)
@click.option('--pipeline-id', default=None,
              help='id associated with the pipeline to get')
@debug_option
@profile_option
@eat_exceptions
@provide_api_client
...
@click.option('--spec', default=None, help=PipelineSpecClickType.help)
@click.option('--pipeline-id', default=None,
              help='id associated with the pipeline to be reset')
@debug_option
@profile_option
@eat_exceptions
@provide_api_client
...
pipelines_group.add_command(delete_cli, name='reset')
