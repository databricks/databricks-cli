...
class StackApi(object):
    ...
    def deploy_resource(self, resource_config, resource_status=None):  # overwrite to be added
        """
    ...
    def deploy_config(self, stack_config, stack_status=None):
        ...
        for resource_config in stack_config[STACK_RESOURCES]:
            ...
            new_resource_status = self.deploy_resource(resource_config, resource_status)
