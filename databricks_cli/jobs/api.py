...
class JobsApi(object):
    ...
    def list_jobs(self, job_type=None, expand_tasks=None, offset=None, limit=None, headers=None, version=None):
        resp = self.client.list_jobs(job_type=job_type, expand_tasks=expand_tasks, offset=offset, limit=limit,
