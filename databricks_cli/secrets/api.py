...
class SecretApi(object):
    ...
    def create_scope(self, scope, initial_manage_principal, scope_backend_type, azure_keyvault_info):
        return self.client.create_scope(scope, initial_manage_principal, scope_backend_type, azure_keyvault_info)
